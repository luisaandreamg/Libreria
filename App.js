...
import Principal from "./components/libreria";
...
export default function App() {
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="LibreríaLAMG">
        <Stack.Screen
          name="Board"
          ...
          options={({ navigation }) => ({
            ...
            headerRight: () => (
              <Button
                ...
                icon={{
                  name: "add-circle",
                  style: { marginRight: 0, fontSize: 28 },
                }}
                onPress={() => {
        ...
        <Stack.Screen name="LibreríaLAMG" component={Principal} />
